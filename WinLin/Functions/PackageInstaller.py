...
===================================================="""
    ...
    if Route == '1':
        ...
        try:  # downloading from GitHub
                ...
                if y in SDir:
                    ...
                    if fi == '0':
                        ...
                        if ffi == 'py':
                            ...
                            print(launch)
                            Form = f'{ChangeDir}@{fi[:-3]} = {launch}%{SourceURI}#{datetime.datetime.now()}'
                            import System.Drive.Errors_Events.EventMan as EV
            ...
            import shutil
            try:
                shutil.rmtree(ChangeDir)
                print('Cleanup complete')
            except:
                print(f'''Cleanup Failed: {ChangeDir} Either Not Present or Other
Try manual removal of {ChangeDir}''')
